...
<?php if ($route == '' || $route  == 'site/index') : ?>
    ...
    <?php
        ...
        ?>
        <div class="hero-wrap js-fullheight" style="background-image: url(<?= Yii::getAlias('@images') . '/' . Tools::MainImg()->main_img ?>);">
    <div class="overlay"></div>
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
            <div class="col-md-7 ftco-animate">
...
<?php else : ?>
    <?php 
        ...
        <div class="container">
            ...
            ?>
            <section class="hero-wrap hero-wrap-2" style="background-image: url('<?= Yii::getAlias('@images') . '/' . Tools::MainImg()->banners ?>');">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
