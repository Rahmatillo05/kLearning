        ...
        ?>
          <div class="staff col-md-4">
            <div class="img-wrap d-flex align-items-stretch">
              <div class="img align-self-stretch" style="background-image: url(<?= Yii::getAlias('@images') ?>/<?= $item->userInfo->image ?? ''   ?>);"></div>
            </div>
            <div class="text pt-3">
              <h3><a href="<?= Url::to(['/teachers/view', 'id' => $item->id]) ?>"><?= $item->full_name ?? '' ?></a></h3>
    ...
    <div class="row">
      ...
      ?>
        <div class="project-wrap col-md-4">
          <a href="<?= Url::to(['course/view', 'id' => $item->id]) ?>" class="img" style="background-image: url(<?= Yii::getAlias('@images') . '/' . $item->image ?>)">
            <span class="price"><?= $item->category->name ?></span>
          </a>
          <div class="text p-4">
            <h3><a href="<?= Url::to(['course/view', 'id' => $item->id]) ?>"><?= $item->title ?></a></h3>
            <p class="advisor">O'qituvchi: <span><a href="<?= Url::to(['teachers/view', 'id' => $item->teacher->id]) ?>"><?= $item->teacher->full_name ?></a></span>
            </p>
            <ul class="d-flex justify-content-between">
              <a href="<?= Url::to(['course/view', 'id' => $item->id, 't_id' => $item->teacher->id]) ?>">Qabulga yozilish</a>
            </ul>
          </div>
        </div>
      <?php
